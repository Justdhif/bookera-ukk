    ...
    public static function generateCollage(array $bookCoverPaths, int $saveId): ?string
    {
        ...
        try {
            ...
            if ($coverCount === 1) {
                ...
                if ($cover1) {
                    $canvas->place($cover1, 'top-left', 0, 0);
                }
                if ($cover2) {
                    $canvas->place($cover2, 'top-left', $halfSize, 0);
                }
            } elseif ($coverCount === 3) {
                ...
                if ($cover3) {
                    $canvas->place($cover3, 'top-left', 0, $halfSize);
                }
            } else {
                ...
                if ($cover4) {
                    $canvas->place($cover4, 'top-left', $halfSize, $halfSize);
                }
            }
