...
export default function LoginPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to setup-profile after successful registration
        ...
        <div className="w-full max-w-md relative" style={{ minHeight: 480 }}>
          <AnimatePresence mode="wait" custom={direction}>
            {mode === "login" ? (
                      ...
                      <div className="text-center pt-2">
                        <p className="text-sm text-gray-600 dark:text-gray-400 transition-colors">
                          ...
                          <button
                            ...
                            className="font-semibold text-brand-primary hover:text-brand-primary-dark transition-colors hover:underline underline-offset-4"
                            disabled={loading}
                          >
                            Daftar sekarang
                          </button>
              ...
              >
                <Card className="w-full border-0 dark:border dark:border-gray-700 shadow-2xl backdrop-blur-sm bg-white/95 dark:bg-gray-900/95 transition-colors overflow-hidden">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-24 h-1.5 bg-linear-to-r from-brand-primary-light to-brand-primary rounded-full"></div>
                  ...
                  <CardHeader className="space-y-4 text-center pb-6">
                    ...
                    <CardDescription className="text-gray-600 dark:text-gray-300 transition-colors">
                      Daftar untuk mulai menggunakan Bookera
                    </CardDescription>
                  </CardHeader>
