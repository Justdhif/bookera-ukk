...
interface ReturnBooksCardProps {
  ...
  onConditionChange: (detailId: number, condition: "good" | "damaged" | "lost") => void;
  onSaveConditions: () => void;
  savingConditions: boolean;
  isLocked: boolean;
}

function ConditionBadge({ condition }: { condition: "good" | "damaged" | "lost" }) {
  const config = {
    good: {
          ...
          >
            ...
            {isLocked ? (
              ...
              <Select
                ...
                onValueChange={(val) =>
                  onConditionChange(detail.id, val as "good" | "damaged" | "lost")
                }
              >
