...
const contents = [
  {
    id: 1,
    category: "News",
    title: "Launching new book collection next week!",
    time: "2 hours ago",
    Icon: Newspaper,
    accent: "#60a5fa",
  ...
  },
  {
    id: 2,
    category: "Promo",
    title: "20% discount on premium borrows this month",
    time: "Today",
    Icon: Megaphone,
    accent: "#34d399",
  ...
  },
  {
    id: 3,
    category: "Event",
    title: "Free literacy webinar — register now!",
    time: "Tomorrow",
    Icon: CalendarDays,
    accent: "#c084fc",
  ...
  },
  {
    id: 4,
    category: "Tips",
    title: "5 ways to maximize catalog search",
    time: "3 hours ago",
    Icon: Lightbulb,
    accent: "#fbbf24",
...
function ArcDecor({ stroke }: { stroke: string }) {
  return (
    ...
    >
      <path
        d="M 70 70 A 62 62 0 0 0 8 70"
        stroke={stroke}
        strokeWidth="0.9"
        opacity="0.7"
      />
      <path
        d="M 70 70 A 44 44 0 0 0 26 70"
        stroke={stroke}
        strokeWidth="0.7"
        opacity="0.5"
      />
      <path
        d="M 70 70 A 26 26 0 0 0 44 70"
        stroke={stroke}
        strokeWidth="0.6"
        opacity="0.35"
      />
...
export default function LiveSectionContent() {
  ...
  return (
    <div
      style={{
        background:
          "linear-gradient(150deg, #0f0f1a 0%, #1a1a2e 50%, #16213e 100%)",
          ...
          {contents.map((_, i) => (
            <button
              ...
              style={{
                ...
                borderRadius: "3px",
                background:
                  i === currentIndex ? current.accent : "rgba(255,255,255,0.2)",
                border: "none",
                cursor: "pointer",
                padding: 0,
                transition: "all 0.3s ease",
                boxShadow:
                  i === currentIndex ? `0 0 6px ${current.accent}80` : "none",
              }}
            />
          ))}
        </div>
