...
export default function SaveCard({ save, onClick }: SaveCardProps) {
        ...
        <div className="flex gap-3">
          <div className="shrink-0">
            {save.cover ? (
              ...
              <div className="w-16 h-20 rounded bg-linear-to-br from-brand-primary to-brand-primary-dark flex items-center justify-center">
  ...
  return <Link href={`/saves/${save.slug}`}>{cardContent}</Link>;
}
