...
export default function CroissantBadge({ className }: CroissantBadgeProps) {
  ...
  return (
    <Badge
      variant="outline"
      className={cn(
        "relative overflow-hidden group h-4 w-4 p-0 flex items-center justify-center shrink-0 border-orange-200/50 dark:border-orange-800/50 bg-orange-50/50 dark:bg-orange-950/30 backdrop-blur-sm text-orange-600 dark:text-orange-400 transition-all duration-300 hover:shadow-[0_0_15px_rgba(249,115,22,0.2)] dark:hover:shadow-[0_0_15px_rgba(249,115,22,0.1)]",
        className
      )}
    >
