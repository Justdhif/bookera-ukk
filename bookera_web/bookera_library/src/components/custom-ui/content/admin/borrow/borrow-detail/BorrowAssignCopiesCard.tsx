  ...
  return (
    <Card className="border-blue-200 bg-blue-50/30">
      <CardHeader>
        ...
        <CardDescription>
          Select an available copy for each book requested. This borrow was
          approved but copies have not been assigned yet.
        </CardDescription>
      </CardHeader>
                ...
                <div key={opt.bookId} className="space-y-2">
                  ...
                  {opt.copies.length === 0 ? (
                    <div className="rounded-lg border border-destructive/40 bg-destructive/5 p-3 text-sm text-destructive">
                      No available copies for this book. Please check the
                      inventory.
                    </div>
                  ) : (
                    <Select
