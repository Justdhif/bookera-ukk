...
export default function DashboardCards({ data }: { data: DashboardTotals }) {
  ...
  const secondaryItems: CardItem[] = [
    {
      label: t("totalCategories"),
      value: data.total_categories,
      icon: LayoutGrid,
      gradient: "from-violet-500 to-purple-500",
      bgGradient: "from-violet-50/40 to-purple-50/40 dark:from-violet-950/20 dark:to-purple-950/20",
      borderColor: "border-violet-200/50 dark:border-violet-800/50",
      hoverBorderColor: "group-hover:border-violet-300 dark:group-hover:border-violet-700",
      iconBg: "bg-linear-to-br from-violet-500 to-purple-500",
      statIcon: Activity,
      statText: t("allCategories"),
      detailsHref: "/admin/categories",
      detailsText: t("manageCategories"),
    },
    {
      ...
      hoverBorderColor: "group-hover:border-pink-300 dark:group-hover:border-pink-700",
      iconBg: "bg-linear-to-br from-pink-500 to-rose-500",
      statIcon: Sparkles,
      statText: t("allAuthors"),
      detailsHref: "/admin/authors",
      detailsText: t("manageAuthors"),
    },
    {
      ...
      hoverBorderColor: "group-hover:border-sky-300 dark:group-hover:border-sky-700",
      iconBg: "bg-linear-to-br from-sky-500 to-blue-500",
      statIcon: Library,
      statText: t("allPublishers"),
      detailsHref: "/admin/publishers",
      detailsText: t("managePublishers"),
    },
    {
      label: t("totalFines"),
      value: `Rp ${Number(data.total_fines ?? 0).toLocaleString("id-ID")}`,
      icon: BadgeDollarSign,
      gradient: "from-lime-500 to-green-500",
      bgGradient: "from-lime-50/40 to-green-50/40 dark:from-lime-950/20 dark:to-green-950/20",
      borderColor: "border-lime-200/50 dark:border-lime-800/50",
      hoverBorderColor: "group-hover:border-lime-300 dark:group-hover:border-lime-700",
      iconBg: "bg-linear-to-br from-lime-500 to-green-500",
      statIcon: BarChart3,
      statText: t("totalFinesCollected"),
      detailsHref: "/admin/fines",
      detailsText: t("viewFines"),
    },
  ];
    ...
    >
      ...
      <CardContent className="pt-0">
        <div className="flex items-end justify-between">
          <p className="text-2xl font-bold tracking-tight bg-linear-to-br from-slate-900 to-slate-700 dark:from-slate-100 dark:to-slate-300 bg-clip-text text-transparent">
        ...
        <div className="mt-4 relative">
          ...
          <div
            className={`relative h-px bg-linear-to-r ${item.gradient} opacity-60 group-hover:opacity-80 transition-opacity duration-500`}
            style={{ width: "60%" }}
          />
        </div>
      </CardContent>
