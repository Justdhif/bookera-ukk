      ...
      <CardContent className="space-y-4 pb-8">
        ...
        >
          ...
          <div className="flex-1 text-left">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 transition-colors whitespace-normal">
              {email
                ? t("verificationCodeSentTo", { email })
                : t("enterEmailFirst")}
            </p>
          </div>
          <Send className="w-5 h-5 text-brand-primary group-hover:translate-x-1 transition-transform shrink-0" />
        </Button>
        <div className="text-center pt-2">
          ...
          >
            ...
            {isAuthenticated ? t("backToProfile") : t("backToLogin")}{" "}
          </Button>{" "}
        </div>{" "}
      </CardContent>{" "}
    </Card>
