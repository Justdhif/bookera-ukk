...
import { User as UserIcon, Send, MessageSquareText, ShieldAlert, AlertTriangle, Loader2, X } from "lucide-react";
...
export default function ChatDetailSheet({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="p-0 w-full sm:max-w-lg border-l-0 flex flex-col h-full bg-background">
        {/* Header */}
        <SheetHeader className="p-4 pr-12 border-b flex-row items-center gap-3 bg-card/95 backdrop-blur-sm shrink-0 h-[68px] space-y-0 text-left">
          <Link 
