...
import { CalendarCheck, Bell, Heart, Sparkles } from "lucide-react";
...
export function PricingCommonFeatures() {
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* Reservation Card */}
      <Card className="group relative overflow-hidden gap-0 rounded-2xl border border-border bg-card p-0 transition-all duration-300 hover:shadow-md hover:border-brand-primary/20">
      ...
      {/* Favorite Card */}
      <Card className="group relative overflow-hidden gap-0 rounded-2xl border border-border bg-card p-0 transition-all duration-300 hover:shadow-md hover:border-rose-500/20">
        <div className="pointer-events-none absolute top-0 left-0 w-28 h-28 rounded-full bg-rose-500/5 blur-2xl" />
        <CardContent className="relative z-10 p-6">
          <div className="w-10 h-10 rounded-xl bg-linear-to-br from-rose-500/15 to-rose-500/5 border border-rose-500/20 flex items-center justify-center mb-4">
...
export function PricingAICard() {
  ...
  return (
    <Card className="relative overflow-hidden flex h-full flex-col gap-0 rounded-2xl border border-brand-primary/30 bg-brand-primary/5 p-0 backdrop-blur-sm transition-all duration-300 hover:border-brand-primary/60 hover:shadow-lg hover:shadow-brand-primary/10 dark:border-brand-primary/40 dark:bg-brand-primary/10">
